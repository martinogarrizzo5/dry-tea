...
const FullCocktail: FC = () => {
  ...
  const getTags = () => {
    return selectedCocktail.strTags ? selectedCocktail.strTags.split(",") : [];
  };
  ...
  return (
    <main className="app__page full-cocktail">
      {selectedCocktail ? (
        <Fragment>
          <h1 className="full-cocktail__title">{selectedCocktail.strDrink}</h1>
          <div className="full-cocktail__container">
            ...
            <div className="full-cocktail__right-side">
              <h2 className="full-cocktail__right-side__title">INGREDIENTS:</h2>
              ...
              <div className="full-cocktail__right-side__glass">
                <span className="full-cocktail__right-side__title">GLASS:</span>
